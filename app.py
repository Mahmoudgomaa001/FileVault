...
async function changeDhikr() {
  ...
  (async ()=>{
    ...
    // Make sure these are defined globally
const pvModal = document.getElementById("pvModal");
const pvPrevBtn = document.getElementById("pvPrevBtn");
const pvNextBtn = document.getElementById("pvNextBtn");
const pvClose = document.getElementById("pvClose");

// Global keyboard navigation
document.addEventListener("keydown", function (e) {
  if (!pvModal.classList.contains("hidden")) {
    if (e.key === "ArrowLeft") {
      e.preventDefault();
      pvPrevBtn.click();
