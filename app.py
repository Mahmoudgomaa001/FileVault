...
def login():
    ...
    return render_template("login.html",
                                   ...
                                   message=message,
                                   authed=is_authed(), icon=None, user_label="", current_rel="", dhikr="", dhikr_list=[], is_admin=False)
...
def unlock():
    ...
    return render_template("unlock.html", error=error, next_url=next_url, authed=False, icon=None, user_label="", current_rel="", dhikr="", dhikr_list=[], is_admin=False)
